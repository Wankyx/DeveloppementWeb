...
<html>
	<head>
		<title>Wankyx - Contactez Moi !</title>
		<meta charset="utf-8">
				...
				<ul>
					<div>
						...
						<li class="info">
							...
							<input type="email" placeholder="Email" id="email" name="email" required="required"></label>
						</li>
					</div>
					<li>
						<textarea required="required" name="textarea" rows="10" cols="50" placeholder="Votre message..."></textarea>
					</li>
